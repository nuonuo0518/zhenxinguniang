...
C:\Users\tiannuoxie\AppData\Local\Programs\Python\Python310\python.exe `
  "C:\Users\tiannuoxie\真心姑娘\agent-sprite-forge-main\skills\generate2dmap-workbuddy\scripts\extract_prop_pack.py" `
  --input "<prop_sheet.png>" `
  --rows <N> --cols <N> `
...
# 分层预览合成
C:\Users\tiannuoxie\AppData\Local\Programs\Python\Python310\python.exe `
  "C:\Users\tiannuoxie\真心姑娘\agent-sprite-forge-main\skills\generate2dmap-workbuddy\scripts\compose_layered_preview.py" `
  --base "<base.png>" `
  --props-json "<props.json>" `
  --output "<preview.png>"
```
