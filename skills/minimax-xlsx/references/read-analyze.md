...
```bash
python SKILL_DIR/scripts/xlsx_reader.py input.xlsx                 # full report
python SKILL_DIR/scripts/xlsx_reader.py input.xlsx --sheet Sales   # single sheet
python SKILL_DIR/scripts/xlsx_reader.py input.xlsx --quality       # quality audit only
python SKILL_DIR/scripts/xlsx_reader.py input.xlsx --json          # machine-readable
```
